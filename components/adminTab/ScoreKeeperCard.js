    ...
    return (
      <View style={{ paddingTop: 20 }}>
        <Card containerStyle={{ width: '100%' }}>
          <View>
            <Button buttonStyle={{ marginBottom: 20, width: 150, height: 35 }} raised title={'Starting hole: ' + this.props.hole} iconRight={{ name: "triangle-down", type: 'entypo' }} onPress={() => { this.props.fun(true) }} />
